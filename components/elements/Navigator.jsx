...
const Navigator = () => {
  ...
  return (
    <div>
      ...
      <section className='px-6'>
        <div className='hover:bg-neutral-700 cursor-pointer flex flex-row items-center justify-center bg-neutral-800 my-6 rounded-3xl p-2 font-[200]'>
      ...
      <ul className='flex flex-col'>
        {dummyPlaylistArray.map((playlist) => {
          return (
            <PlayListNav key={playlist.owner} playlist={playlist}></PlayListNav>
          )
        })}
      </ul>
    </div>
